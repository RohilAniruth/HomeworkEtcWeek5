...
{
    public Transform FishPath3;
    public Transform FishPath4;
    ...
    void Update()
    {
        ...
        transform.position = Vector3.Lerp(FishPath3.position, FishPath4.position, percent);
        transform.rotation = Quaternion.Slerp(FishPath3.rotation, FishPath4.rotation, percent);
